...
void Federation::Starfleet::Captain::setAge(int newAge) {
    _age = newAge;
}

void Federation::Starfleet::Ship::promote(Federation::Starfleet::Captain *cpt) {
    std::cout << cpt->getName() << ": I'm glad to be the captain of the USS" << _name << "."<< std::endl;
}